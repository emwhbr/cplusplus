...
io_exception::io_exception(const char *file,
			   int line,
			   const char *pretty_function,
			   IO_ERROR_SOURCE source,
			   long code,
			   const char *info_format, ...)
{
  ...
  m_thread_id  = io_get_my_thread_id();
  m_process_id = io_get_my_pid();
}

////////////////////////////////////////////////////////////////

io_exception::~io_exception(void) throw()
{
}

////////////////////////////////////////////////////////////////

string io_exception::get_function(void)
{
...
void io_exception::get_stack_frames(STACK_FRAMES &frames)
{
...
string io_exception::get_class_method(const string pretty_function)
{
