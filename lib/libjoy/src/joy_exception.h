...
#ifndef __JOY_EXCEPTION_H__
#define __JOY_EXCEPTION_H__
...
#define EXP(source, code, info_format, ...) \
  joy_exception(__FILE__, __LINE__, __PRETTY_FUNCTION__, \
...
typedef struct {
  ...
  uint64_t frames[MAX_NR_STACK_FRAMES];
} STACK_FRAMES;
